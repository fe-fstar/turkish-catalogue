...
export default function Header() {
    return (
        <header className="absolute top-0 left-0 w-screen p-4 flex items-center justify-evenly bg-cafe_noir *:text-white *:basis-1/3 *:flex *:items-center shadow-lg border-b-2 border-lemon_chiffon">
